...
func New(sessionStore *sessions.CookieStore, dynamicClient dynamic.Interface) *chi.Mux {
	...
	actionHandlers := action.NewHandlers(sessionStore, dynamicClient, "default", schema.GroupVersionResource{Group: "edge.harmonycloud.cn", Version: "v1alpha1", Resource: "nodemaintenances"})
